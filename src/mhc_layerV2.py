...
def get_init_and_expand_reduce_stream_functions(
    ...
    **kwargs
    ...
    hyper_conn_klass = ManifoldConstrainedHyperConnectionsV2 if not disable else Residual
...
class ManifoldConstrainedHyperConnectionsV2(Module):
    """
    Manifold Constrained Hyper Connections V2
    
    Appendix J, Algorithm2 in - https://arxiv.org/abs/2409.19606
    Frac-connections paper - https://arxiv.org/abs/2503.14125
...
mHCV2 = ManifoldConstrainedHyperConnectionsV2

# Attach static methods to class
ManifoldConstrainedHyperConnectionsV2.get_expand_reduce_stream_functions = staticmethod(get_expand_reduce_stream_functions)
ManifoldConstrainedHyperConnectionsV2.get_init_and_expand_reduce_stream_functions = staticmethod(get_init_and_expand_reduce_stream_functions)
