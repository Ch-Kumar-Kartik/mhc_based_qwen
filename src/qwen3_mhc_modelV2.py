...
class Qwen3MHCConfigV2(PretrainedConfig):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # Qwen3RotaryEmbedding expects rope_parameters dict
        if rope_parameters is None:
            ...
            if rope_scaling:
                ...
                rope_params["rope_type"] = rope_scaling.get("type", rope_params["rope_type"])
...
class Qwen3MHCModelV2(PreTrainedModel):
    ...
    def forward(
        ...
        **kwargs,
        ...
        # KV-cache is not compatible with activation checkpointing during training.
...
class Qwen3MHCForCausalLMV2(PreTrainedModel, GenerationMixin):
    ...
    def _set_gradient_checkpointing(self, enable: bool = True, gradient_checkpointing_func=None):
        """Enable or disable gradient checkpointing (transformers >=4.35 API)."""
        if gradient_checkpointing_func is not None:
            self.model._gradient_checkpointing_func = gradient_checkpointing_func
